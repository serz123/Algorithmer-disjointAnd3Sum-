...
public class ChartFind extends JFrame {
  ...
  private XYSeriesCollection createDataset() {
    ...
    for (int i = 10; i < listSizes.length; i++) {
      long timeuf = unionFindMeasuring.measureFind(i,5, 6);
      long timewquf = wqUnionFindMeasuring.measureFind(i,5, 6);
