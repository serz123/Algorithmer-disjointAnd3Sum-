...
public class ChartSeveralUnions extends JFrame {
  ...
  public ChartSeveralUnions (String title) {
    super(title);
  ...
  private XYSeriesCollection createDataset() {
    ...
    for (int i = 10; i < listSizes.length; i++) {
      long timeuf = unionFindMeasuring.measureFewUnions(100,5, 6, i);
      long timewquf = wqUnionFindMeasuring.measureFewUnions(100,5, 6, i);
